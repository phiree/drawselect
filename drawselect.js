$.fn.DrawSelect = function (options) {
    ...
    $(that).mousedown(function (e) {
        ...
        drawDiv.css({'left': lastDrawDivStartPosition.left + 'px', 'top': lastDrawDivStartPosition.top + 'px', width: 0, height: 0});//drawDiv.css(lastDrawDivStartPosition);
        console.log(lastDrawDivStartPosition);
        e.preventDefault();
    });
    ...
    $(that).mousemove(function (e) {
        ...
        if (is_mouse_down) {
            ...
            lastDrawDiv.css({width: width_abs - 5 + 'px', height: height_abs - 5 + 'px'});
    ...
    function ChangeSelectedStatus() {
        ...
        var draw_div_data = {left: last_draw_div.offset().left,
    ...
    childrenDivs.mouseenter(function (e) {
        if (is_mouse_down) {
